            ...
            <div className='row' style={{ padding: "15px" }}  >
                {bottomdata.map((value) =>
                    <div className='col-md-3'  id='img'onClick={()=>{handleOpen(value.imdbID)}}>
                        <Card sx={{ maxWidth: 345, height: 420, backgroundColor: 'cornflowerblue'}} className='cards'>
                            <CardMedia
                                component="img"
                                height="140"
                                image={value.Poster}
                            ...
                            <p style={{textAlign:"center", color:'antiquewhite'}}>Type: {value.Type}</p>
                            <p style={{textAlign:"center", color:'antiquewhite'}}>Year: {value.Year}</p>
                            <p style={{textAlign:"center", color:'antiquewhite'}}>IMDBID: {value.imdbID}</p>
                            {/* </div> */}
                        </Card>
                    </div>
